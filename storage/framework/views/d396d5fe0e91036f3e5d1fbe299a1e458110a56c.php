		...
		<div id="gasflow_list" class="tab-pane fade">
			...
			<div class="table table-condensed table-responsive" style='overflow-y:scroll;height:275px'>          
				<table class="table">
					...
					<tbody>
					<?php foreach($dbdata as $gasflow): ?>
						<tr>
							<td><?php echo e($gasflow->recorded_on); ?></td>
							<td><?php echo e($gasflow->flow); ?></td>
						</tr>
					<?php endforeach; ?>
					</tbody>
				</table>
...
<?php $__env->startSection('footer_js'); ?>
  ...
  <script type="text/javascript">
	...
	var gasflow_lineChartData = {
		labels: [<?php foreach($x_gasflow_data as $pt): ?>"<?php echo e($pt); ?>",<?php endforeach; ?>],
		datasets: [{
			fillColor: "rgba(220,220,220,0)",
			strokeColor: "rgba(220,180,0,1)",
			pointColor: "rgba(220,180,0,1)",
			data: [<?php foreach($y_gasflow_data as $pt): ?>"<?php echo e($pt); ?>",<?php endforeach; ?>]
		}]
	}
