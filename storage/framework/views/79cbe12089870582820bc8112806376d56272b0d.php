...
var baseGraphOptions = $.extend(true, {}, lineOptionsTemplate, {
    scales: {
        yAxes: [{
            scaleLabel: {
                labelString: "<?php echo e(Lang::get('bioreactor.ph_axis_full')); ?>",
            }
        }],
        xAxes: [{
            scaleLabel: {
...
var big_phOptions = $.extend(true, {}, baseGraphOptions, {
    title: {
        text: "<?php echo e(Lang::get('bioreactor.chart_ph_title_big')); ?>"
    }
});
var full_phOptions = $.extend(true, {}, baseGraphOptions, {
    title: {
        text: "<?php echo e(Lang::get('bioreactor.chart_ph_title_full')); ?>"
    }
});
