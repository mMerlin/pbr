...
<?php echo Form::model($user, array('class' => 'form', 'name' => 'ChangePassword')); ?>


<input name="GoBackTo" type="hidden" value="<?php echo e(URL::previous()); ?>">

<div class="form-group">
    <?php echo Form::label('New Password'); ?>

    <?php echo Form::password('password1', array('id' => 'password1')); ?>

</div>

<div class="form-group">
    <?php echo Form::label('Repeat Password'); ?>

    <?php echo Form::password('password2', array('id' => 'password2')); ?>
