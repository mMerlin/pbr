...
(function () {
    ...
    cnst.weekday_names = [<?php foreach($date_constants['weekday'] as $nm): ?>"<?php echo e($nm); ?>"<?php if($nm !== end($date_constants['weekday'])): ?>, <?php endif; ?><?php /* */ ?><?php endforeach; ?>];
    cnst.month_names = [<?php foreach($date_constants['month'] as $nm): ?>"<?php echo e($nm); ?>"<?php if($nm !== end($date_constants['month'])): ?>, <?php endif; ?><?php /* */ ?><?php endforeach; ?>];
    ...
    base.chartDataSet.full = {
        pointRadius: <?php echo e($sensor['point_count'] > 170 ? 1 :( $sensor['point_count'] > 50 ? 2 : 3 )); ?>,
        pointHoverRadius: <?php echo e($sensor['point_count'] > 120 ? 6 : 12); ?>,
        pointHoverBorderWidth: <?php echo e($sensor['point_count'] > 120 ? 1 : 2); ?>,
    ...
    base.chartOptions.big = {
        ...
        scales: {
            xAxes: [{
                scaleLabel: {
                    labelString: "<?php echo e(Lang::get('bioreactor.time_axis_hhmm')); ?>"
                },
                time: {
                    unit: "minute",
                    unitStepSize: 10
    ...
    base.chartOptions.full = {
        ...
        scales: {
            ...
            xAxes: [{
                scaleLabel: {
                    labelString: "<?php echo e($interval_count > 10 ? Lang::get('bioreactor.time_axis_time') : Lang::get('bioreactor.time_axis_hhmm')); ?>"
                },
                time: {
                    unit: "<?php echo e($interval_count > 108 ? 'day' :( $interval_count > 10 ? 'hour' : 'minute' )); ?>",
                    unitStepSize: <?php echo e($interval_count > 744 ? 7 :( $interval_count > 108 ? 1 :( $interval_count > 57 ? 3 :($interval_count > 33 ? 2 :( $interval_count > 10 ? 1 :( $interval_count > 4 ? 30 :( $interval_count > 2 ? 10 : 5 ))))))); ?>
