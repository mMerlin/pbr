      ...
      <div id="temp_list" class="tab-pane fade">
        ...
        <div class="table table-condensed table-responsive" style='overflow-y:scroll;height:275px'>
          <table class="table">
            ...
            <tbody>
            <?php foreach($dbdata as $temperature): ?>
              <tr>
                <td><?php echo e($temperature->recorded_on); ?></td>
                <td><?php echo e($temperature->temperature); ?></td>
              </tr>
            <?php endforeach; ?>
            </tbody>
          </table>
...
<script>
  var temp_lineChartData = {
    labels: [<?php foreach($x_temperature_data as $pt): ?>"<?php echo e($pt); ?>",<?php endforeach; ?>],
    datasets: [{
      fillColor: "rgba(220,220,220,0)",
      strokeColor: "rgba(220,180,0,1)",
      pointColor: "rgba(220,180,0,1)",
      data: [<?php foreach($y_temperature_data as $pt): ?>"<?php echo e($pt); ?>",<?php endforeach; ?>]
    }]
  }
  ...
  var tempOptions = {
    scales: {
      ...
      xAxes: [{
        scaleLabel: {
          display: true,
          labelString: "Time (HH:MM) ending at: <?php echo e($end_datetime); ?>",
          fontSize: 14,
        },
      }]
    },
