			...
			<div id="lux_list" class="tab-pane fade">
				...
				<div class="table table-condensed table-responsive" style='overflow-y:scroll;height:275px'>
					<table class="table">
						...
						<tbody>
							<?php foreach($dbdata as $lightreading): ?>
							<tr>
								<td><?php echo e($lightreading->recorded_on); ?></td>
								<td><?php echo e($lightreading->lux); ?></td>
							</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
...
<?php $__env->startSection('footer_js'); ?>
  ...
  <script type="text/javascript">
	...
	var temp_lineChartData = {
		labels: [<?php foreach($x_lightreading_data as $pt): ?>"<?php echo e($pt); ?>",<?php endforeach; ?>],
		datasets: [{
			fillColor: "rgba(220,220,220,0)",
			strokeColor: "rgba(220,180,0,1)",
			pointColor: "rgba(220,180,0,1)",
			data: [<?php foreach($y_lightreading_data as $pt): ?>"<?php echo e($pt); ?>",<?php endforeach; ?>]
		}]
	}
